    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/30">
      ...
      <section id="about" className="py-24 bg-secondary/20">
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            <p className="mb-6">
              Hello! I'm a dedicated student and developer with a love for building things that live on the internet. My interest in web development started back in 2020 when I decided to try editing custom Tumblr themes — turns out hacking together HTML & CSS is pretty fun!
            </p>
            <p>
              Fast-forward to today, and I've had the privilege of working on various projects, from simple landing pages to complex full-stack applications. My main focus these days is building accessible, inclusive products and digital experiences for a variety of clients.
            </p>
          </motion.div>
        </div>
      </section>
