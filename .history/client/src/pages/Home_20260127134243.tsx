    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/30">
      ...
      <section id="about" className="py-24 bg-secondary/20">
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            <p className="mb-6">
              I am a MERN Stack Web Developer with a strong foundation in JavaScript, React, Node.js, and MongoDB. With a background in Computer Science Engineering (Diploma + B.Tech),<br></br> I have hands-on experience in building full-stack applications.
